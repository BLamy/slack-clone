...
**38 / 95 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E4-T08** — Capstone: a real Cloudflare OS workspace executes a pinned run under deny-by-default policy, survives reconnect, and leaves no orphan *(awaiting independent critic)*
...
- [x] `   7` [E0-T07](epic-0-the-ledger/E0-T07-two-writers-one-log/readme.md) — Capstone: two writers, one authoritative log **[CAPSTONE]** *(deps: E0-T03, E0-T06)*
...
- [x] ` 108` [E1-T08](epic-1-the-workspace/E1-T08-multi-user-chat-api/readme.md) — Capstone: multi-user, agent-ready chat API **[CAPSTONE]** *(deps: E1-T06, E1-T07)*
...
- [x] ` 207` [E2-T07](epic-2-the-roster/E2-T07-immutable-invocation-snapshot/readme.md) — Immutable, capability-resolved invocation snapshot *(deps: E2-T02, E2-T05)*
- [x] ` 208` [E2-T08](epic-2-the-roster/E2-T08-configure-reconfigure-revoke-agent/readme.md) — Capstone: configure, reconfigure, and revoke an agent **[CAPSTONE]** *(deps: E2-T04, E2-T06, E2-T07)*
...
- [x] ` 303` [E3-T03](epic-3-the-dispatcher/E3-T03-durable-run-queue-and-leases/readme.md) — Durable run queue, fenced worker leases, and scoped capabilities *(deps: E3-T01, E3-T02)*
...
- [x] ` 308` [E3-T08](epic-3-the-dispatcher/E3-T08-mention-to-scripted-agent-reply/readme.md) — Capstone: mention to scripted agent reply **[CAPSTONE]** *(deps: E3-T05, E3-T06, E3-T07)*
...
- [x] ` 402` [E4-T02](epic-4-the-cloudflare-os/E4-T02-cloudflare-os-control-plane/readme.md) — Cloudflare OS control plane: authenticated workspace and Gadget lifecycle behind SandboxProvider *(deps: E4-T01)*
- [x] ` 403` [E4-T03](epic-4-the-cloudflare-os/E4-T03-pinned-workspace-materialization/readme.md) — Pinned workspace materialization: one invocation digest becomes one byte-exact sandbox tree *(deps: E4-T02)*
...
- [x] ` 407` [E4-T07](epic-4-the-cloudflare-os/E4-T07-quotas-costs-and-orphan-gc/readme.md) — Sandbox quotas, cost accounting, and orphan garbage collection from provider-observed reality *(deps: E4-T04, E4-T06)*
