...
**10 / 95 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E1-T04** — Message, thread, edit, delete, and reaction event contract *(awaiting independent critic)*

## Next up (dependencies satisfied)

No new task may start until **E1-T04** clears the gate.

## Unlocks when E1-T04 verifies

1. **E1-T05** — Resumable live chat API without polling
1. **E1-T06** — Canonical structured mentions as durable trigger facts
