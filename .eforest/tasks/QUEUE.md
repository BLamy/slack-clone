...
**24 / 95 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E3-T02** — Idempotent mention-to-invocation reconciler *(awaiting independent critic)*

## Next up (dependencies satisfied)

No new task may start until **E3-T02** clears the gate.

## Unlocks when E3-T02 verifies
