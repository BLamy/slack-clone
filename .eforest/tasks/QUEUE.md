...
**35 / 95 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E4-T05** — Default-deny sandbox networking: destination allowlists, metadata blocking, and auditable egress decisions *(awaiting independent critic)*
