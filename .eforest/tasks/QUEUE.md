...
**13 / 95 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E1-T07** — Checkpointed, rebuildable chat projections *(awaiting independent critic)*

## Next up (dependencies satisfied)

No new task may start until **E1-T07** clears the gate.

## Unlocks when E1-T07 verifies
