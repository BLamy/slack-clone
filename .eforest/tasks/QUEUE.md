...
**27 / 95 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E3-T05** — Per-conversation batching, serialization, and recursion guards *(awaiting independent critic)*

## Next up (dependencies satisfied)

1. **E3-T06** — Cancellation, retries, deadlines, and resource budgets
1. **E3-T07** — Agent replies bound to run provenance and current membership

## Unlocks when E3-T05 verifies
