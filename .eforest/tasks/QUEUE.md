...
**22 / 95 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E2-T08** — Capstone: configure, reconfigure, and revoke an agent *(awaiting independent critic)*

## Next up (dependencies satisfied)

No new task may start until **E2-T08** clears the gate.

## Unlocks when E2-T08 verifies
