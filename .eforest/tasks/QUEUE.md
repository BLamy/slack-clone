...
1. **E0-T02** — Strangler backend workspace around the working chat demo *(builder working)*

## Next up (dependencies satisfied)

No new task may start until **E0-T02** clears the gate.

## Unlocks when E0-T02 verifies

1. **E0-T03** — Official Durable Streams adapter with resumable reads
