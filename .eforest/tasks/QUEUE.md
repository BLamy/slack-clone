...
1. **E1-T03** — Channel lifecycle, membership, and private-read isolation *(awaiting independent critic)*

## Next up (dependencies satisfied)

No new task may start until **E1-T03** clears the gate.

## Unlocks when E1-T03 verifies

1. **E1-T04** — Message, thread, edit, delete, and reaction event contract
