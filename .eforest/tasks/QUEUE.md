...
**34 / 95 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified · `[-]` cancelled

## Current gate

1. **E4-T04** — Streaming execution and cancellation: ordered output, reconnectable offsets, and fenced process termination *(awaiting independent critic)*
...
## Unlocks when E4-T04 verifies

1. **E4-T06** — Ephemeral and persistent sandbox lifecycles: explicit retention, resume, reset, and destruction semantics
