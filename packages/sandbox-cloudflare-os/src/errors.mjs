export const CLOUDFLARE_OS_ERROR_CODES = Object.freeze({
  ...
  GC_INVALID_REQUEST: "CLOUDFLARE_OS_GC_INVALID_REQUEST",
  GC_OWNERSHIP_MISMATCH: "CLOUDFLARE_OS_GC_OWNERSHIP_MISMATCH",
  GC_DESTROY_FAILED: "CLOUDFLARE_OS_GC_DESTROY_FAILED",
  GC_CLOCK_INVALID: "CLOUDFLARE_OS_GC_CLOCK_INVALID",
  GC_PAGINATION_INVALID: "CLOUDFLARE_OS_GC_PAGINATION_INVALID",
});
