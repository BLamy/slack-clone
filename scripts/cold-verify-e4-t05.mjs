...
const commit = String(
  process.env.E4_T05_IMPLEMENTATION_COMMIT ??
...
if (!/^[0-9a-f]{40}$/u.test(commit))
  throw new Error("E4-T05 requires an exact implementation commit");
...
const task = path.join(
  root,
  ".eforest/tasks/epic-4-the-cloudflare-os/E4-T05-default-deny-network-policy",
);
...
try {
  ...
  execFileSync("node", ["scripts/verify-e4-t05.mjs"], {
    cwd: checkout,
    env: {
      ...process.env,
      E4_T05_IMPLEMENTATION_COMMIT: commit,
