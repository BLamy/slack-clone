...
const commit = String(
  process.env.E4_T06_IMPLEMENTATION_COMMIT ??
...
if (!/^[0-9a-f]{40}$/u.test(commit))
  throw new Error("E4-T06 requires an exact implementation commit");
...
const task = path.join(
  root,
  ".eforest/tasks/epic-4-the-cloudflare-os/E4-T06-ephemeral-and-persistent-lifecycles",
);
...
try {
  ...
  execFileSync("node", ["scripts/verify-e4-t06.mjs"], {
    cwd: checkout,
    env: {
      ...coldEnv,
      E4_T06_IMPLEMENTATION_COMMIT: commit,
